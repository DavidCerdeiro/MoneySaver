...
public class AccountIntegrationTest {
    ...
    public void testSaveAccount() {
        ...
        account.setAccountCode("tl_id_123456");
        accountRepository.save(account);

        Assertions.assertTrue(accountRepository.existsByUser(user));
    }
    ...
    public void testSaveDuplicateTrueLayerThrowsException() {
        ...
        account1.setAccountCode("tl_id_123456");
        ...
        account2.setAccountCode("tl_id_123456");
