...
export function EditProfileForm({user, fetchData, typeCharts}: ModifyProfileFormProps) {
  ...
  const initialSelectedTypeChart = user
    ? typeCharts.find(tc => tc.id === user.idTypeChart) || null: null;
  const isDemoUser = sessionStorage.getItem('isDemoMode') === 'true';
        ...
        <div className="general-container">
            <div className="row-input mb-5">
                <div className="w-full">
                    ...
                    <Input id="name" {...register('name')} className="input-form" disabled={isDemoUser}/>
                    {errors.name && (
                ...
                <div className="w-full">
                    ...
                    <Input id="surname" {...register('surname')} className="input-form" disabled={isDemoUser}/>
                    {errors.surname && (
            ...
            <div className="row-input mb-5">
                <div className="w-full">
                    ...
                    <Input type="email" id="email" defaultValue={user?.email} {...register('email')} className="input-form" disabled={isDemoUser}/>
                    {errors.email && (
            ...
            <div className="row-input mb-4">
                <div className="w-full">
                    ...
                    <Input type="password" id="password" {...register('password')} className="input-form" disabled={isDemoUser}/>
                    {errors.password && (
                ...
                <div className="w-full">
                    ...
                    <Input type="password" id="confirmPassword" {...register('confirmPassword')} className="input-form" disabled={isDemoUser}/>
          ...
          <Dialog>
            <DialogTrigger asChild disabled={isSubmitting}>
              <Button className="button-neutral" disabled={isDemoUser}>
