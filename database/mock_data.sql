...
(2, 4, 'ING', 'Ahorros Ana', 'ACC-ANA-002', 'ES9100000000000000000002');
...
(1, 4, 'Supermercados', 'convenience_store', '2026-01-01', NULL),
(2, 4, 'Ocio y Suscripciones', 'cinema', '2026-01-01', NULL),
(3, 4, 'Transporte', 'bus', '2026-01-01', NULL),
(4, 4, 'Ropa y Accesorios', 'necktie', '2026-02-01', NULL),
(5, 4, 'Electrónica', 'technologist', '2026-01-01', NULL),
(6, 4, 'Suscripciones Temp', 'tv', '2026-01-01', '2026-04-01');
...
(5, 6, 11, 'Prueba HBO Max', 9.99, '2026-01-10'),
(6, 1, 6, 'Compra semanal Aldi', 42.15, '2026-01-12'),
(7, 2, 3, 'Libros Kindle', 12.50, '2026-01-20'),
(8, 5, 3, 'Ratón Gaming Amazon', 45.00, '2026-01-15'),

-- Gastos de Febrero 2026
(9, 1, 7, 'Compra Carrefour', 120.00, '2026-02-03'),
(10, 4, 4, 'Camisa y Pantalón Zara', 65.50, '2026-02-10'),
(11, 2, 13, 'Cuota Gimnasio', 35.00, '2026-02-20'),
(12, 6, 11, 'Disney Plus Promo', 8.99, '2026-02-10'),
(14, 1, 8, 'Fruta y verdura Lidl', 15.60, '2026-02-05'),
(15, 2, 5, 'Entradas Cine ECI', 18.00, '2026-02-14'),
(16, 4, 9, 'Ropa básica Primark', 35.00, '2026-02-15'),
(17, 5, 1, 'Monitor Curvo', 199.00, '2026-02-28'),

-- Gastos de Marzo 2026
(18, 1, 8, 'Compra Lidl', 45.20, '2026-03-05'),
(19, 2, 3, 'Juego Amazon', 59.99, '2026-03-12'),
(20, 1, 2, 'Mercadona Reposición', 22.10, '2026-03-10'),
(21, 2, 1, 'Videojuego MediaMarkt', 69.95, '2026-03-25'),
(22, 4, 4, 'Vestido Zara', 49.95, '2026-03-01'),
(23, 3, 12, 'Billete AVE', 75.00, '2026-03-15'),
(24, 3, 12, 'Taxi Estación', 15.40, '2026-03-15'),

-- Gastos de Abril 2026
(25, 1, 2, 'Compra Mercadona', 32.10, '2026-04-02'),
(26, 1, 7, 'Compra mensual Carrefour', 145.00, '2026-04-05'),
(27,  3, 12, 'Bono tren', 50.00, '2026-04-10'),
(28, 5, 1, "Ratón gaming", 20.00, '2026-04-12'),
(29, 4, 10, 'Zapatillas Decathlon', 59.90, '2026-04-08');
...
-- Gasto ID 11: Gimnasio el día 20. Expiración debe ser el día 20 de un mes futuro.
...
(3, 11, 1, '2027-02-20', '2026-03-20');  -- Gimnasio (Mensual, expira el próximo año)
